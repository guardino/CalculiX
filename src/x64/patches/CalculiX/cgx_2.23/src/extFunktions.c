...
void calcNurbsResolution( int nr)
{
  ...
  sem_wait(&sem_g);
#if TEST
  printf("in calcNurbsResolution nurbs:%s \n", nurbs[nr].name);
#endif
...
int sphToNurs(int s, int flag)
{
  ...
  double controlPoint[]={
   ...
   0.17453241, 0.50000000, 0.00000000,
   0.34906906, 0.43146144, 0.00000000,
   0.49282665, 0.29438147, 0.00000000,
   0.57512122, 0.10487885, 0.00000000,
   0.57512126, -0.10487889, 0.00000000,
   0.49282667, -0.29438145, 0.00000000,
   0.34906911, -0.43146136, 0.00000000,
   0.17453237, -0.49999999, 0.00000000,
   0.00000000, -0.50000000, 0.00000000,
   0.00000000, 0.50000000, 0.00000000,
   0.17453445, 0.50000000, -0.06853851,
   0.34907314, 0.43146144, -0.13707869,
   0.49283241, 0.29438147, -0.19353200,
   0.57512794, 0.10487885, -0.22584890,
   0.57512798, -0.10487889, -0.22584892,
   0.49283243, -0.29438145, -0.19353201,
   0.34907319, -0.43146136, -0.13707871,
   0.17453441, -0.49999999, -0.06853850,
   0.00000000, -0.50000000, 0.00000000,
   0.00000000, 0.50000000, -0.00000000,
   0.14376072, 0.50000000, -0.13707893,
   0.28752493, 0.43146144, -0.27416119,
   0.40593672, 0.29438147, -0.38706937,
   0.47372198, 0.10487885, -0.45170407,
   0.47372202, -0.10487889, -0.45170411,
   0.40593673, -0.29438145, -0.38706938,
   0.28752497, -0.43146136, -0.27416122,
   0.14376069, -0.49999999, -0.13707890,
   0.00000000, -0.50000000, -0.00000000,
   0.00000000, 0.50000000, -0.00000000,
   0.08229110, 0.50000000, -0.18950320,
   0.16458420, 0.43146144, -0.37901099,
   0.23236514, 0.29438147, -0.53509961,
   0.27116659, 0.10487885, -0.62445312,
   0.27116661, -0.10487889, -0.62445317,
   0.23236515, -0.29438145, -0.53509963,
   0.16458423, -0.43146136, -0.37901104,
   0.08229109, -0.49999999, -0.18950316,
   0.00000000, -0.50000000, -0.00000000,
   -0.00000000, 0.50000000, -0.00000000,
   -0.00000000, 0.50000000, -0.20975569,
   -0.00000000, 0.43146144, -0.41951647,
   -0.00000000, 0.29438147, -0.59228652,
   -0.00000001, 0.10487885, -0.69118938,
   -0.00000001, -0.10487889, -0.69118942,
   -0.00000000, -0.29438145, -0.59228654,
   -0.00000000, -0.43146136, -0.41951653,
   -0.00000000, -0.49999999, -0.20975565,
   0.00000000, -0.50000000, -0.00000000,
   -0.00000000, 0.50000000, -0.00000000,
   -0.08229111, 0.50000000, -0.18950319,
   -0.16458421, 0.43146144, -0.37901098,
   -0.23236516, 0.29438147, -0.53509961,
   -0.27116661, 0.10487885, -0.62445312,
   -0.27116663, -0.10487889, -0.62445316,
   -0.23236517, -0.29438145, -0.53509962,
   -0.16458424, -0.43146136, -0.37901104,
   -0.08229109, -0.49999999, -0.18950315,
   -0.00000000, -0.50000000, -0.00000000,
   -0.00000000, 0.50000000, -0.00000000,
   -0.14376070, 0.50000000, -0.13707892,
   -0.28752490, 0.43146144, -0.27416117,
   -0.40593668, 0.29438147, -0.38706935,
   -0.47372194, 0.10487885, -0.45170405,
   -0.47372197, -0.10487889, -0.45170408,
   -0.40593669, -0.29438145, -0.38706936,
   -0.28752494, -0.43146136, -0.27416121,
   -0.14376067, -0.49999999, -0.13707889,
   -0.00000000, -0.50000000, -0.00000000,
   -0.00000000, 0.50000000, 0.00000000,
   -0.17453445, 0.50000000, -0.06853851,
   -0.34907314, 0.43146144, -0.13707869,
   ...
   -0.34907314, 0.43146144, 0.13707869,
   -0.49283241, 0.29438147, 0.19353200,
   -0.57512794, 0.10487885, 0.22584891,
   -0.57512798, -0.10487889, 0.22584892,
   -0.49283243, -0.29438145, 0.19353201,
   -0.34907319, -0.43146136, 0.13707871,
   -0.17453441, -0.49999999, 0.06853850,
   ...
   -0.28752493, 0.43146144, 0.27416119,
   -0.40593672, 0.29438147, 0.38706937,
   -0.47372198, 0.10487885, 0.45170408,
   -0.47372202, -0.10487889, 0.45170411,
   -0.40593673, -0.29438145, 0.38706938,
   -0.28752497, -0.43146136, 0.27416123,
   -0.14376069, -0.49999999, 0.13707890,
   -0.00000000, -0.50000000, 0.00000000,
   -0.00000000, 0.50000000, 0.00000000,
   -0.08229110, 0.50000000, 0.18950320,
   -0.16458420, 0.43146144, 0.37901099,
   -0.23236514, 0.29438147, 0.53509961,
   -0.27116659, 0.10487885, 0.62445313,
   -0.27116661, -0.10487889, 0.62445317,
   -0.23236515, -0.29438145, 0.53509963,
   -0.16458423, -0.43146136, 0.37901105,
   -0.08229109, -0.49999999, 0.18950316,
   -0.00000000, -0.50000000, 0.00000000,
   0.00000000, 0.50000000, 0.00000000,
   0.00000000, 0.50000000, 0.20975569,
   ...
   0.00000000, 0.29438147, 0.59228652,
   0.00000001, 0.10487885, 0.69118938,
   0.00000001, -0.10487889, 0.69118943,
   0.00000000, -0.29438145, 0.59228654,
   0.00000000, -0.43146136, 0.41951653,
   0.00000000, -0.49999999, 0.20975565,
   -0.00000000, -0.50000000, 0.00000000,
   0.00000000, 0.50000000, 0.00000000,
   0.08229111, 0.50000000, 0.18950319,
   0.16458421, 0.43146144, 0.37901099,
   0.23236516, 0.29438147, 0.53509961,
   0.27116661, 0.10487885, 0.62445312,
   0.27116663, -0.10487889, 0.62445316,
   0.23236517, -0.29438145, 0.53509962,
  ...
  if(flag)
  {
    ...
    /* vector to u/2,v/2 */
    sem_wait(&sem_g);
    //pnr=nurbs[nr].ctlpnt[8][5];
    pnr=nurbs[nr].ctlpnt[0][0];
  ...
  v_norm( p1, p1 );
  for(j=0; j<3; j++)  printf("p:%s v sph xyz:%f\n",point[pnr].name,p1[j]);
  for(j=0; j<3; j++)  printf("p:%s v sph xyz:%f\n",point[nurbs[nr].ctlpnt[0][0]].name,p1[j]);
#endif
  repNurs(nr);
  sem_post(&sem_g);
...
int calcTrimLoops(int nurbsnr, int nr)
{
 ...
 newTrimming:;
  ...
  // check which curve is the outer loop (usually the longest line loop)
  p1[2]=p2[2]=0.;
  for (i=0; i<surf[nr].nc; i++)
  {
  ...
  // check, which curve has the point which is most far away from the center nu,nv
  c_outer=0;
  p1[2]=p2[2]=0.;
  for (i=0; i<surf[nr].nc; i++)
  {
  ...
  sem_post(&sem_g);
      v_result( p1, p2, p1p2 );
      lp1p2=v_betrag( p1p2 );
      if(lp1p2>rmax) { rmax=lp1p2; c_outer=i; }
    }while(cp<nurbsbuf[0]);
  }
...
int repSurf(int nr, int renderFlag )
{
  ...
  if(sem_wait(&sem_rep)) printf("Error in:sem_wait\n");
    // use only linear elements for rendering to be more flexible with line div.
    if(surf[nr].etyp==8) { j=8; surf[nr].etyp=7; }
    else if(surf[nr].etyp==10) { j=10; surf[nr].etyp=9; }
    else j=0;
    fillBlendedSurf(nr);
